...
void solvability_calc::calculate_solvability_percentage(uint64_t timeout_, int seed_count_, uint32_t cores,
...
void solvability_calc::solver_thread(solvability_calc* sc, uint32_t core) {
