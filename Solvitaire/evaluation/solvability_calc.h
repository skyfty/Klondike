...
public:
    ...
    void calculate_solvability_percentage(uint64_t, int, uint32_t, command_line_helper::streamliner_opt, const std::vector<int>&);
...
private:
    ...
    // Solving methods
    static void solver_thread(solvability_calc*, uint32_t core);
